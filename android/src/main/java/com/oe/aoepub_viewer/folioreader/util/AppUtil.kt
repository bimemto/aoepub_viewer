package com.oe.aoepub_viewer.folioreader.util
...
import com.oe.aoepub_viewer.folioreader.util.SharedPreferenceUtil.getSharedPreferencesString
    ...
    companion object {
        ...
        fun saveConfig(context: Context?, config: Config) {
            ...
            try {
                ...
                obj.put(Config.CONFIG_IS_NIGHT_MODE, config.colorMode)
