package com.oe.aoepub_viewer.folioreader.ui.fragment
...
import com.oe.aoepub_viewer.folioreader.ui.view.FolioWebView
import com.oe.aoepub_viewer.folioreader.ui.view.WebViewPager
...
import com.oe.aoepub_viewer.folioreader.mediaoverlay.MediaController
import com.oe.aoepub_viewer.folioreader.mediaoverlay.MediaControllerCallbacks
import com.oe.aoepub_viewer.folioreader.model.HighLight
import com.oe.aoepub_viewer.folioreader.model.HighlightImpl
import com.oe.aoepub_viewer.folioreader.model.event.*
...
import com.oe.aoepub_viewer.folioreader.model.sqlite.HighLightTable
import com.oe.aoepub_viewer.folioreader.ui.activity.FolioActivityCallback
import com.oe.aoepub_viewer.folioreader.ui.base.HtmlTask
import com.oe.aoepub_viewer.folioreader.ui.base.HtmlTaskCallback
import com.oe.aoepub_viewer.folioreader.ui.base.HtmlUtil
import com.oe.aoepub_viewer.folioreader.ui.view.LoadingView
import com.oe.aoepub_viewer.folioreader.ui.view.VerticalSeekbar
import com.oe.aoepub_viewer.folioreader.util.AppUtil
import com.oe.aoepub_viewer.folioreader.util.HighlightUtil
...
class FolioPageFragment : Fragment(),
    ...
    private fun updatePagesLeftTextBg() {
        when (mConfig!!.isNightMode) {
            ...
            2 -> {
                mRootView!!.findViewById<View>(R.id.indicatorLayout)
                        .setBackgroundColor(Color.parseColor("#E2E5EA"))
            }
            1 -> {
                mRootView!!.findViewById<View>(R.id.indicatorLayout)
                        .setBackgroundColor(Color.parseColor("#E2E2EF"))
            }
            else -> {
                mRootView!!.findViewById<View>(R.id.indicatorLayout)
