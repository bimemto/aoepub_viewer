...
public class SwiftAoepubViewerPlugin: NSObject, FlutterPlugin,FolioReaderPageDelegate,FlutterStreamHandler {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
      let channel = FlutterMethodChannel(name: "aoepub_viewer", binaryMessenger: registrar.messenger())
      let instance = SwiftAoepubViewerPlugin()
  ...
  //    result("iOS " + UIDevice.current.systemVersion)
      ...
      private func setPageHandler(){
        SwiftAoepubViewerPlugin.pageChannel?.setStreamHandler(self)

      }
      
      public func onListen(withArguments arguments: Any?, eventSink events: @escaping FlutterEventSink) -> FlutterError? {
        SwiftAoepubViewerPlugin.pageResult = events
          return nil
      }
      ...
      public func pageWillLoad(_ page: FolioReaderPage) {
          ...
          if (SwiftAoepubViewerPlugin.pageResult != nil){
            SwiftAoepubViewerPlugin.pageResult!(String(page.pageNumber))
          }
